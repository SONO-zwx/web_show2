...
class CertificateImg(models.Model):
    ...
    onloadinfo = models.IntegerField(blank=True, null=True)
...
class Carinfoimg(models.Model):
    img_url = models.ImageField(upload_to='carinfoimg/', blank=True, null=True)  # ָ��ͼƬ�ϴ�·������media/photos/
    for_id = models.TextField(blank=True, null=True)
...
class Kindsimg(models.Model):
    img_url = models.ImageField(upload_to='kindsimg/', blank=True, null=True)  # ָ��ͼƬ�ϴ�·������media/photos/
    for_id = models.TextField(blank=True, null=True)
...
class Xiaoxi(models.Model):
    chuliren = models.IntegerField(blank=True, null=True)
    nextchuliren = models.IntegerField(blank=True, null=True)
    chulishijian = models.DateTimeField(blank=True, null=True)
    isok = models.IntegerField(blank=True, null=True)
    chuliendshijian = models.DateTimeField(blank=True, null=True)
    ischaoshi = models.IntegerField(blank=True, null=True)
    biaoming = models.TextField(blank=True, null=True)
